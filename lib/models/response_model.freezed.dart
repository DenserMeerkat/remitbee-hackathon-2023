...
class _$ResponseModelImpl implements _ResponseModel {
  const _$ResponseModelImpl({required this.success, required this.result});
  ...
  @override
  String toString() {
    return 'ResponseModel(success: $success, result: $result)';
  }
...
abstract class _ResponseModel implements ResponseModel {
  const factory _ResponseModel(
      ...
      required final double result}) = _$ResponseModelImpl;
